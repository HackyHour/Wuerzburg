...
### Problems
 - R script with ordering of rows
 - Mattermost kitchen duty reminder bot :male-cook: ([incoming webhook](https://developers.mattermost.com/integrate/webhooks/incoming/?utm_source=mattermost&utm_medium=in-product&utm_content=installed_incoming_webhooks&uid=8gtq7te3ii8k3dat8gougi6ikh&sid=zpab8ynqn38rzx36tryxqszfsr)) 

### Meta
- Posters
- Schafkopf-Abend on the 04.12.
- Boardgame evening on the 11.12 @ 7pm in the TP1 Seminar room
- There is the idea floating around, that we start with a Visit to the Christmas market.
...
### Fun
 ...
 - deploy [custom RAG](https://python.langchain.com/docs/tutorials/rag/) via [Open WebUI Pipelines](https://docs.openwebui.com/pipelines/) :computer: 
...
## Cross Links
 - [previous pad](https://hackyhour.github.io/Wuerzburg/pad_archive/HackyHour_Wuerzburg_097)
 - [next pad](https://hackyhour.github.io/Wuerzburg/pad_archive/HackyHour_Wuerzburg_099)
