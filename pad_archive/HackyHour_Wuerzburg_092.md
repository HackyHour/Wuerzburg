# HackyHour Würzburg 92

## Live
 - **When:** Monday June 24^th^, 2024 at 5pm c.t.
...
Konkrete Probleme:
 - Wie kann man Bootloader durch den Standard-EFI-Bootloader ersetzen?
 - Problem: Grosshandler data read errors (try [memtest?](https://github.com/integralfx/MemTestHelper/tree/oc-guide))

Fun:
 - Poster Draft (Kerstin) + Direktansprache anderer Fakultäten? + Gina Social Media Bio
 - [marimo](https://marimo.io/) a next-generation Python notebook
 - [openalexR](https://docs.ropensci.org/openalexR/)

### Maybe another time

 - Fun: controlling RGB devices via [OpenRGB](https://openrgb.org/) or [python](https://github.com/jath03/openrgb-python)
...
## Cross Links
 - [previous pad](https://hackyhour.github.io/Wuerzburg/pad_archive/HackyHour_Wuerzburg_091)
 - [next pad](https://hackyhour.github.io/Wuerzburg/pad_archive/HackyHour_Wuerzburg_093)