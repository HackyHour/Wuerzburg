# HackyHour Würzburg 94

## Live
 - **When:** Monday August 26^th^, 2024 at 17:15
...
### Problems
- Keybindings via VNC on Discounter :heavy_check_mark: 
...
### Fun
 ...
 - Guess Dice Score game using [FastHTML](https://www.fastht.ml/)

### Maybe another time
 - modify [Geographical Adventure](https://github.com/SebLague/Geographical-Adventures) with vacation locations ([ideas](/LYtvW7WTQta0FYgAK2VGTw)) → Suggestion: extraordinary HackyHour with Felix et al.
 - [openalexR](https://docs.ropensci.org/openalexR/)
 - [ORKG - Open Research Knowledge Graph](https://orkg.org/)
 - Version control with [jujutsu](https://martinvonz.github.io/jj/latest/tutorial/)
 ...
 - Analyze history of HackyHour pizza orders → TODO Markus get email confirmations
